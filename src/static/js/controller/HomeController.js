...
var HomeController = function($scope) {
    ...
    $scope.shouldBeCheckAll = function(event){
        if (!document.getElementById(event.target.id).checked){
            ...
            if(event.target.id.endsWith("-_-all")){
                ////TODO: Tick all distro specific checkboxes of this OS
                //
                
                ////TODO: Then if all other OS specific checkboxes are ticked then tick the "check_all" checkbox
                //
            }
        }
    };
